...
const Payment: React.FunctionComponent<Props> = ({ navigation }: Props) => {
      ...
      <ScrollView>
        ...
        <View style={style.contentContainer}>
          ...
          <View
            style={[
              style.container,
              { paddingLeft: 0, paddingRight: 0, paddingTop: 30 },
            ]}
          >
            <View
              style={[style.childContainer, style.leftContainer, { flex: 2 }]}
            >
              <View
                style={[
                  style.hairline,
            ...
            <View
              style={[style.childContainer, style.centerContainer, { flex: 1 }]}
            >
            ...
            <View
              style={[style.childContainer, style.rightContainer, { flex: 2 }]}
            >
              <View
                style={[
                  style.hairline,
